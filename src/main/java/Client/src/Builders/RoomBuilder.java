...
import Client.src.entities.PlacementSlot;
import Client.src.entities.Room;
import Client.src.enums.Environment;

import java.util.ArrayList;

public class RoomBuilder {

    //this class is low-key more Director than Builder so may change name later :)
    ...
    public Room buildCommonRoom(){
        ...
        slots.add(new PlacementSlot(Environment.HUMID_SUNNY)); //index 10
        slots.add(new PlacementSlot(Environment.HUMID_SHADE)); //index 11
